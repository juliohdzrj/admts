...
set_time_limit(0);	  
$folder = "img/";
$file = basename( $_FILES['archivo2']['name']);
$full_path = $folder.$file;

if(move_uploaded_file($_FILES['archivo2']['tmp_name'], $full_path)) { 
//echo "Carga exitosa";
$img_url= $full_path;
/*************************************
 * 
 ************************************/
	...
	*/
	...
	$nuevaImgName="img/rr".$current_id.$_POST['regLasInsertId'].".jpg";
...
$updateImg=$insertarFile->upImgHeaders();
if($updateImg!="true"){
	echo ($updateImg);
	}else{
	echo ("Se almaceno su archivo: <br> <a href=\"../vista/consultaF7.php?1perAwtXyzdd22ret56=".$promoid."\" target=\"_blank\">".$nombre_archivo."</a>");
	}
unlink($img_url);
unlink($nuevaImgName);	
exit;		
