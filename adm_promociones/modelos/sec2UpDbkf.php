 ...
 ************************************/
	...
	*/
	...
	$nuevaImgName="img/r1".$current_id.".jpg";
...
$updateImg=$insertarFile->upImgFichaBk();
if($updateImg!="true"){
	echo ($updateImg);
	}else{
	echo ("Se almaceno su archivo: <br> <a href=\"../vista/consultaF4.php?1perAwtXyzdd22ret56=".$_SESSION["ficha"]."\" target=\"_blank\">".$nombre_archivo."</a>");
	}
unlink($img_url);
unlink($nuevaImgName);	
exit;		
