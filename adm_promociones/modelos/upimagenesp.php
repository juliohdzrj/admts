...
//echo "Carga exitosa";
            ...
            */
            ...
            $nuevaImgName="../../promo-medicas/".$nameSinExtencion."-".$_POST["idsoc"].".jpg";
            ...
            $soloname=$nameSinExtencion."-".$_POST["idsoc"].".jpg";
...
//$contenido = addslashes($contenido);
        ...
        $updatefichaimg=new regDirSMB($db);

        $resUpdImgFicha=$updatefichaimg->updateespimg($_POST["idsoc"],$soloname);
        echo($resUpdImgFicha);
