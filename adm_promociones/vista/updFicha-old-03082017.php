...
========================================================================================================*/	
	...
	$selectPlantilla="";
	$selectPlantilla.='<select class="plantillatipo" name="plantillatipo" onChange="edoplan(\'plantillatipo\')">';
	($dataFicha["tipoplan"]==="0")?$selectPlantilla.='<option value="0" selected>Plantilla 1</option><option value="1">Plantilla 2</option>':$selectPlantilla.='<option value="0">Plantilla 1</option><option value="1" selected>Plantilla 2</option>';
	$selectPlantilla.='</select>';
	
	
	
	/*<?php echo ($dataFicha["tipoplan"]); ?>
<select name="plantillatipo">
...
<input class="btn btn-default" type="button" onclick="confirma(<?php echo ($idFicha.",'cimg1'") ?>)" value="Borrar imagen">
...
<input class="btn btn-default" type="button" onclick="confirma(<?php echo ($idFicha.",'backimg2'") ?>)" value="Borrar imagen">
...
<input class="btn btn-default" type="button" onclick="confirma(<?php echo ($idFicha.",'promopdf3'") ?>)" value="Borrar PDF">
...
<input class="btn btn-default" type="button" onclick="confirma(<?php echo ($idFicha.",'sucspdf4'") ?>)" value="Borrar PDF">
...
<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
<span class="color1">Selecciona el tipo de plantilla</span><br>
