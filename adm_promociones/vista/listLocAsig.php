...
$listaLocAsig=$getLocAsig->getLocAsig($idFicha);
$nrow=$listaLocAsig->rowCount();
$dataLocAct=false;
//$dataLocAct.="";
//$arrayLoc=array();
while($rowLocAsig=$listaLocAsig->fetch(PDO::FETCH_ASSOC)){
	$dataLocAct.="<div class=\"checkbox\"><label><input type=\"checkbox\" name=\"localidad-".$rowLocAsig["id_localidades_asignadas"]."\" value=\"".$rowLocAsig["id_localidades_asignadas"]."\">".utf8_encode($rowLocAsig["nombre_localidad"])."</label></div>";	
